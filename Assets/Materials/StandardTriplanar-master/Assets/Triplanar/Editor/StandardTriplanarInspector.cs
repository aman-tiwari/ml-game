...
public class StandardTriplanarInspector : ShaderGUI
{
    static class Styles
    {
        static public readonly GUIContent albedoForward = new GUIContent("Forward Albedo", "Albedo (RGB)");
        static public readonly GUIContent albedoRight = new GUIContent("Right Albedo", "Albedo (RGB)");
        static public readonly GUIContent albedoUp = new GUIContent("Up Albedo", "Albedo (RGB)");
    ...
    public override void OnGUI(MaterialEditor editor, MaterialProperty[] props)
    {
        ...
        editor.TexturePropertySingleLine(
            Styles.albedoForward, FindProperty("_ForwardTex", props), FindProperty("_Color", props)
        );
        editor.TexturePropertySingleLine(
            Styles.albedoRight, FindProperty("_RightTex", props), FindProperty("_Color", props)
        );
        editor.TexturePropertySingleLine(
            Styles.albedoUp, FindProperty("_UpTex", props), FindProperty("_Color", props)
        );
